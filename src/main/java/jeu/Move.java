		...
		try {
			...
			if (c5 == 'q') {
				...
				if (eq.couleur == true)
					...
					color = "noir";
				promotedPiece = new Reine(color, c3 - 97, c4 - 49, eq);
				// eq.setCase((int) (c3 - 97), (int) (c4 - 49), new Reine(color, c3 - 97, c4 -
				// 49, eq));
			}
				...
				if (eq.couleur == true)
					...
					color = "noir";
				promotedPiece = new Tour(color, c3 - 97, c4 - 49, eq);
				// eq.setCase((int) (c3 - 97), (int) (c4 - 49), new Tour(color, c3 - 97, c4 -
				// 49, eq));
			}
				...
				if (eq.couleur == true)
					...
					color = "noir";
				promotedPiece = new Cavalier(color, c3 - 97, c4 - 49, eq);
				// eq.setCase((int) (c3 - 97), (int) (c4 - 49), new Cavalier(color, c3 - 97, c4
				// - 49, eq));
			}
				...
				if (eq.couleur == true)
					...
					color = "noir";
				promotedPiece = new Fou(color, c3 - 97, c4 - 49, eq);
				// eq.setCase((int) (c3 - 97), (int) (c4 - 49), new Fou(color, c3 - 97, c4 - 49,
				// eq));
			}
